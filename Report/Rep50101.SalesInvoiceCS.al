report 50101 "Sales Invoice_CS"
{
    RDLCLayout = '.\RDLC\SalesInvoice_NMS.RDLC';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                /* Comment out for future removal 2024/8/24
            ...
            begin
                CurrReport.Language := Language_CU.GetLanguageIdOrDefault("Language Code");
                ...
                //end;
                if "Currency Factor" <> 0 then CurrExhRate := 1 / "Currency Factor";
    ...
    begin
        ...
        LogInteraction := SegManagement.FindInteractionTemplateCode("Interaction Log Entry Document Type"::"Sales Inv.") <> '';//update for version 25.0.22269.0 
    end;
    ...
    begin
        ...
        if LineFeeNoteOnReportHist.FindSet() then
            ...
            LineFeeNoteOnReportHist.SetRange("Language Code", Language_CU.GetUserLanguageCode());
            if LineFeeNoteOnReportHist.FindSet() then
                repeat
                    TempLineFeeNoteOnReportHist.Init();
                    TempLineFeeNoteOnReportHist.Copy(LineFeeNoteOnReportHist);
