report 50015 "Update Local Item Master - SPE"
{
    ApplicationArea = All;
    Caption = 'Update Local Item Master - Special';
    UsageCategory = Tasks;
    ...
    dataset
    {
        dataitem("Corporate Item Master"; "Corporate Item Master")
        {
            ...
            begin
                ...
                //Update specific date range for error recovery
                DateFromParam := '';
                JobQueueEntry.SetRange("Object Type to Run", JobQueueEntry."Object Type to Run"::Report);
                JobQueueEntry.SetFilter("Object ID to Run", '50015');
                If JobQueueEntry.FindFirst() Then
                    DateFromParam := JobQueueEntry."Parameter String";
                If DateFromParam = '' then
                    ERROR('Parameter string must not be blank.');
                If Not Evaluate(DateFromDate, DateFromParam) then
                    ERROR('Parameter string must be in the date format of your region. (YYYYMMDD, MMDDYYYY or DDMMYYYY)');
                "Corporate Item Master".SETRANGE("Corporate Item Master"."Revision Date", DateFromDate, 29991231D);
            end;
